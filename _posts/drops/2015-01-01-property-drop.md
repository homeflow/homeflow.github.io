...
This is a comprehensive list of the methods available to theme templates as Liquid variables from property pages. To use these within the infinite scroll template on the properties index page, they will need to be added to the [_properties_list.ljson](/property-results/infinite-scrolling.html) file.
