...
Notably, the save/cancel buttons associated with the drawing, editing and deleting tools can become misaligned and to remedy this one can just append a style to the CLASS HERE.

It is possible to extensively retheme draw a map (see: leaders) but that is beyond the scope of this documentation.
